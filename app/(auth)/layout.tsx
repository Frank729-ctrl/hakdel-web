    ...
    <div className="min-h-screen bg-bg flex">
      ...
      <div className="hidden lg:flex flex-col w-[480px] bg-surface border-r border-border p-12 relative overflow-hidden">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-dim mt-4 text-sm leading-relaxed">
                Containerized exploitation labs, live network scanners, and a CEH-aligned drill bank for SOC analysts and pentesters.
              </p>
            </div>
        ...
        <div className="relative z-10 mt-auto flex items-center justify-between">
          ...
          <span className="text-xs font-mono text-muted">v2.7.0</span>
        </div>
      </div>
