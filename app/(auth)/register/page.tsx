  ...
  if (done) {
    return (
      <div className="text-center">
        ...
        <p className="text-sm text-dim mb-6">We sent a verification link to <span className="text-ink">{form.email}</span>.</p>
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input className="input" type="text" placeholder="coolhacker" value={form.username}
            onChange={(e) => setForm({ ...form, username: e.target.value })} required minLength={3} maxLength={32} />
        </div>
        <div>
