...
async function lookup(query: string) {
  const res = await fetch('/api/tools/cve', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ query }) })
...
export default function CvePage() {
  return (
    <ToolShell title="CVE Lookup" description="Search the NVD database by CVE ID or keyword."
      inputLabel="CVE ID or keyword" placeholder="CVE-2024-1234 or 'apache log4j'" onSubmit={lookup}
